        ...
        public void run() {
            ...
            try {
                synchronized (logsTxt) {
                    server.addRequest("Incoming request - " + sockets.getInetAddress().getHostName() + "\n\n");
                }
                ...
                synchronized (logsTxt) {
                    server.addRequest("Request from " + sockets.getInetAddress().getHostName() + " successfully terminated\n\n");
                }
            } catch (Exception ex) {
                synchronized (logsTxt) {
